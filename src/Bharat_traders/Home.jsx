...
// // import d from './images/Bakery6.jpeg'
// import Navbar from './Navbar';
// import Footer from './Footer';

// // Image Slider Component
// const ImageSlider = () => {
//   const images = [a, b, c]; // Use the imported images
...
//   //Handle the AddToCart button to call the backend API.
//   const handleAddToCart = async (productId) => {
//     try {
//       const cartId = localStorage.getItem("cartId"); // Assume cartId is stored in local storage after login
//       const response = await fetch(`http://localhost:8080/cart-items/${cartId}/add/${productId}/1`, {
//         method: "POST",
//       });
...
//               <span><button id='Addtocart' onClick={() => handleAddToCart(product.productId)}>Add To Cart</button></span>
